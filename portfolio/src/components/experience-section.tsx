...
const experiences = [
  ...
  },
  {
    ...
    description: "Progressed from Senior Software Engineer to Deputy CTO over 7 years, leading technical architecture and full-stack development teams. Spearheaded enterprise-scale SaaS development, mobile applications, and major technology migrations while managing a development team.",
    achievements: [
